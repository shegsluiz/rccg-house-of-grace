...
const replacements = [
  ...
  { regex: /\btext-gray-500\b/g, replacement: 'text-gray-500' },
  ...
  { regex: /\btext-gray-200\b/g, replacement: 'text-zinc-800' },
  { regex: /\bvia-green-100\b/g, replacement: 'via-purple-900/40' },
  { regex: /\bfocus:border-green-400\b/g, replacement: 'focus:border-purple-400' }
];
